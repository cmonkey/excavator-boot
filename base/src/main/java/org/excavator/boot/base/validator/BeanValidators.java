 ...
 */
package org.excavator.boot.base.validator;
...
public class BeanValidators {
    ...
    public static <T> void validate(final T t) {
        ...
        if (constraintViolations.size() > 0) {
            ...
            throw new BusinessException(500, buffer.toString());
        }
    }
    ...
    public static void validateWithException(final Validator validator, final Object object,
                                             final Class<?>... groups)
